...
import { Button } from "../../../storybook-react/src/stories/Button"
  ...
  import * as Reacttsx from "../../../storybook-react/src/stories/Input/Input.tsx?raw";
        ...
        <div className={mdxWrapStyle}>
            <div className={mdxViewStyle}>
                <iframe
                    ...
                    src="http://localhost:6007/iframe.html?id=input-components-input--default&viewMode=story&refId=react&globals="
                    width="100%"
                ></iframe>
                <iframe
                    className={`${mdxViewItem} ${radioCheck != "Core" ? 'hide' : ''}`}
                    src="http://localhost:6006/iframe.html?id=input-components-input--default&viewMode=story&refId=react&globals="
                    width="100%"
                ></iframe>
            </div>
